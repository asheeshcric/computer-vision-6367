function [confusion, accuracy] = classify_knn_bow()
    ...
    while ischar(label_path)
        ...
        imagestring = extractBetween(label_path,idx+1,length(space));
    ...
    dict_size = 50;
    [vocab] = build_visual_dictionary(training_image_cell, dict_size);
    ...
    k=7;
    [label_test_pred] = predict_knn(feature_train_BOW,label_train, feature_test_BOW,k);
